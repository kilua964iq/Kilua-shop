# main.py - MUSTAFA SHOP DIGITAL EMPIRE v7 (FIXED & UPGRADED)
...
# ============================================
# دوال GitHub - مُصلحة للملفات الكبيرة
# ============================================

async def get_github_file(path: str = "main.py") -> Optional[str]:
    """جلب ملف من GitHub - مُصلح للملفات الكبيرة"""
    ...
    try:
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            if resp.status_code == 200:
                data = resp.json()
                # ✅ الإصلاح: شيل أسطر base64 الزيادة
                if data.get("encoding") == "base64" and data.get("content"):
                    return base64.b64decode(data["content"].replace("\n", "")).decode('utf-8')
                # ✅ fallback للملفات الكبيرة جداً
...
# ============================================
# ✅ معالج رسائل موحد (إصلاح التكرار)
# ============================================
